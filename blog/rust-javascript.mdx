...
this language will not be ideal because of various reason.
...
etc. This doesn't mean web developers have to start learning rust or go, but you can start using tools which are built on
...
It was mainly built to avoid the use of a centralized repository system (npm), and “heavy-handed tooling.”
