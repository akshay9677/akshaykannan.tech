...
about Netlify and migrated my deployments to it. Since I was using my website for testing out new stuffs,
...
Because of create-react-app I had a better development environment for react. I was mind-blown by react, it facilitates the overall
process of writing components and also I was able to develop stuff faster with hot reloads.

## Next js

Next js was one of the latest addition to my website, I published my first blog last year December. I built it by coding a blog posting, rich text editor
, to post new blogs. Later I switched to MDX and I was setting it up using craco and using appropriate mdx plugins. I used craco to override the
...
I was manually writing all my css, before I found out about tailwind. Tailwind has a lot of reusable css classes, which you can
use to incorporate any css styles.

For example the following code below can easliy be written using tailwind,
...
is more than sufficient. For peeps who are looking for chosing your stack for your blog, can actually use this tech stack.
