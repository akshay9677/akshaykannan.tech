...
tags:
  ["Single page application", "Server side rendering", "Static side generation"]
body: "Learn the difference between SPAs, SSRs and SSGs, which really helps in choosing the right framework for your next application"
id: 11
---
...
only a single html is rendered and the frameworks api code or javascript code is used to render other stuffs which has the
