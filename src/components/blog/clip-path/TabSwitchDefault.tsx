...
const TabSwitchDefault = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center border border-border-secondary rounded-lg py-6 my-4 gap-2">
      <div className="relative flex">
        <div className="bg-[var(--sh-keyword)] w-full h-full flex z-40 tab-switch-clip-path">
          {tabs.map((tab, index) => {
            return (
              <div
                key={index}
...
export default TabSwitchDefault;
