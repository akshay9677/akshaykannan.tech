  ...
  return (
    <div className={`mt-10 ${className}`}>
      ...
      <div className="group relative flex flex-col pb-8 pl-7 last:pb-0 mt-2">
        ...
        <div className="absolute left-0 top-2 h-2 w-2 rounded-full border border-brand-primary bg-primary"></div>
        <h3 className="mt-2 text-sub-heading text-content-primary">
          Facilio, Member of Technical Staff
        </h3>
        <p className="mt-0.5 text-sm/6 text-content-primary/80">
          Working on the core front-end team, where I build frameworks for the
          web interfaces of facilio.
        </p>
      </div>
      <div className="group relative flex flex-col pb-8 pl-7 last:pb-0">
        <div className="absolute left-0 top-2 h-2 w-2 rounded-full border border-brand-primary bg-primary"></div>
        <h3 className="mt-2 text-sub-heading text-content-primary">
